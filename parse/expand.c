...
/*   Updated: 2023/01/03 23:15:53 by rferradi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*find_var(t_data *data, char *var)
{
	...
	while (tmp)
	{
		if (ft_strncmp(var, tmp->content, (ft_strlen(var))) == 0 && tmp->content[len] == '=')
...
void	expand(char **str, t_data *data)
{
	...
	data->cmd->args = malloc(sizeof(char *) * 6);
	ft_memset(data->cmd->args, 0, sizeof(char *));
	ft_printf("la\n");
